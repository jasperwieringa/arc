...
PrimaryTwo.args = { ...defaultArgs, color: THEME_PALETTE.secondary };

export const Default = Template.bind({});
Default.args = { ...defaultArgs, color: THEME_PALETTE.default };

export const Error = Template.bind({});
Error.args = { ...defaultArgs, color: THEME_PALETTE.error };

export const Warning = Template.bind({});
Warning.args = { ...defaultArgs, color: THEME_PALETTE.warning };

export const Info = Template.bind({});
Info.args = { ...defaultArgs, color: THEME_PALETTE.info };

export const Success = Template.bind({});
Success.args = { ...defaultArgs, color: THEME_PALETTE.success };
