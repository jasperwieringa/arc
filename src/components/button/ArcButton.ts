...
import { INPUT_SIZES, InputSize, THEME_PALETTE, ThemePalette } from '../../internal/constants/styleConstants.js';
    ...
    return html`
      <${tag}
        ...
        class=${classMap({
          ...
          'button--default': this.color === THEME_PALETTE.default,
          'button--primary': this.color === THEME_PALETTE.primary,
          'button--secondary': this.color === THEME_PALETTE.secondary,
          'button--error': this.color === THEME_PALETTE.error,
          'button--warning': this.color === THEME_PALETTE.warning,
          'button--info': this.color === THEME_PALETTE.info,
          'button--success': this.color === THEME_PALETTE.success,
